...
<div className="flex-grow font-bold md:text-2xl text-xl">
  ...
  <div className="flex flex-col items-center justify-center"> 
    ...
    <div className="flex flex-col items-center justify-center"> 
    <button className="mt-4 px-6 py-2 bg-transparent text-white border-2 border-solid border-white rounded-lg hover:bg-[#F09E24] hover:border-2 hover:border-transparent">Contact US</button>
    </div>
  </div>
